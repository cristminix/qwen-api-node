    ...
    const tools: Tool[] = [
        {
            ...
            parameters: {
                location: { type: 'string', description: 'The city and state, e.g. San Francisco, CA', required: true },
                unit: { type: 'string', description: "The unit of temperature, can be 'celsius' or 'fahrenheit'" }
            }
        }
    ];
